...
function Account() {
    return ( 
        ...
        <Header/>
            ...
            <h1 className="text-uppercase fw-bolder fs-2">A powerful BEST course that is easy to use for<br/>
            <span className="">ACCOUNT</span></h1>
            <p className="mt-2">Discover our specialized web development services in <b>Kotputli</b>, focusing on <b>Digital Computer Technology.</b> We craft tailored strategies using advanced tech to boost online presence and efficiency. Elevate your digital footprint with our expertise in <b>Kotputli</b> and beyond.<br/>
    ...
    <button type="button" className="btn text-white fw-bold px-4 my-3 rounded-pill">DURATION: 9 MONTHS</button>
    <button type="button" className="btn text-white fw-bold px-4 my-3 mx-3 rounded-pill">FEES: 15,000/- Only</button>
      <p className="pe-5">
        <div className="d-flex">
        <ul className="text-uppercase" style={{width:"40%"}}>
          <li>BASIC COMPUTER</li>
          <li>ADVANCE COMPUTER</li>
          <li>INTRODUCTION OF ACCOUNTING</li>
        </ul>
        <ul className="text-uppercase">
          <li>TALLY</li>
          <li>BILLING</li>
        </ul>
        </div>Embark on an enriching accounting course in Kotputli, where traditional financial principles meet cutting-edge digital computer technology. Learn essential skills in financial management and proficiency in Tally software, complemented by digital tools crucial for modern accounting practices. Ideal for students and professionals in Kotputli looking to elevate their careers with practical knowledge of digital advancements. Enroll now to gain a competitive edge in the dynamic field of accounting amidst Kotputli’s burgeoning digital landscape.</p>
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
    ...
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      ...
      <p>Learn basics: hardware, software, operating systems, internet, email, word processing, spreadsheets, and troubleshooting. Essential skills for computer literacy and productivity in today's digital world.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_ad_computer_icon.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">ADVANCE COMPUTER</h5>
      <p>Advanced accounting course covers topics like financial modeling, data analysis with software (e.g., Excel), ERP systems,and advanced financial reporting, crucial for accounting professionals in complex environments.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_tally_icon.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">TALLY</h5>
      <p>Tally course covers ledger management, invoicing, financial statements, VAT, GST, payroll, and reporting, crucial for streamlined accounting processes in businesses.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_billing_icon.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">BILLING</h5>
      <p>Billing course includes invoicing, payment processing, account reconciliation, billing software, customer communication, and compliance, essential for effective financial management in businesses.</p>
    </div>
  </div>
            </div>
        </section>
    ...
    <div className="col-sm popular-courses shadow bg-body-tertiary rounded">
    <Link to="/webdesigner"><img src="./images/digital_computer_technology_kotputli_game-development.webp" width={"100%"} alt=""/></Link>

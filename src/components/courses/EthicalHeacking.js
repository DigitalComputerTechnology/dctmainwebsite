...
function EthicalHeacking() {
    return ( 
        <>
        <section className="courses-first-section pt-4" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/digital_computer_technology_kotputli_course_Ethical-hacking-headimg.png)`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
        <Header/>
            <div className="container my-5">
            <div className="row text-center">
            <h1 className="text-uppercase fw-bolder fs-2 text-white">A powerful professional course that is easy to use for Ethical-Hacking.</h1>
    ...
    <button type="button" className="btn text-white fw-bold px-4 my-3 mx-3 rounded-pill">FEES: 50,000/- Only</button>
      <p className="pe-5">
        ...
        </div>Delve into the ethical hacking course in Kotputli,Computer Courses in Kotputli where cybersecurity meets cutting-edge digital computer technology. Computer Institute in Kotputli Learn penetration testing, network security, and ethical hacking techniques essential for safeguarding digital assets. Best Computer Classes in Kotputli Perfect for IT professionals and enthusiasts in Kotputli aiming to enhance their cybersecurity skills. Gain hands-on experience with tools like Kali Linux in simulated environments. Enroll today to become proficient in ethical hacking and protect against digital threats in Kotputli’s rapidly advancing technological landscape.</p>
    </div>
    <div className="secound col-sm header-img">
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide1.png" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide4.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide3.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide2.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
  </div>
      ...
      <img className="p-0 cdd" src="./images/digital_computer_technology_kotputli_digital1.png" alt=""/>
        ...
        <section className="courses-third-section my-5 pt-5">
            ...
            <div className="row">
              ...
              <p className="text-center fs-5 mt-3 mb-5 main-paragraph">OnLearning is a powerful online software suite that combines all the tools of <br/> Kotputli Computer Education
              Essential for running a successful school or office.<br/> Programming Classes in Kotputli
              </p>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-icon1.jfif" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">INTRODUCTION</h5>
      <p>Introduction to ethical hacking in Kotputli, leveraging Digital Computer Technology for cybersecurity skills essential in protecting digital assets and networks.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-icon2.png" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">Wireless cracking</h5>
      <p>Master wireless cracking in Kotputli through ethical hacking. Utilize Digital Computer Technology for secure network assessment and defense strategies.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-icon3.png" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">Scanning</h5>
      <p>Learn scanning techniques in Kotputli's ethical hacking course. Utilize Digital Computer Technology for comprehensive vulnerability assessments and network security enhancements.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-icon4.jfif" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">WEBSITE testing</h5>
      <p>Explore website penetration testing in Kotputli's ethical hacking course. Use Digital Computer Technology to secure online platforms through rigorous vulnerability assessments.</p>
    </div>
  </div>
            </div>
        </section>
...
export default EthicalHeacking;

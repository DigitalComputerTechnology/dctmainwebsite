...
function TallyWithGst() {
    return ( 
        ...
        <Header/>
            ...
            <h1 className="text-uppercase fw-bolder fs-2">A powerful BEST course that is easy to use for <br/> <span className="">Tally-With-Gst</span></h1>
    ...
    <button type="button" className="btn text-white fw-bold px-4 my-3 mx-3 rounded-pill">FEES: 50,000/- Only</button>
      <p className="pe-5">
        ...
        <ul>
          <li>SERVICES TAX</li>
          <li>STOCK ANALYSIS VAT</li>
        </ul>
        </div>Explore our Tally-with-GST course in Kotputli, integrating essential digital computer technology. Master GST compliance, invoicing, and financial reporting using Tally, alongside digital tools crucial for modern accounting. Ideal for individuals in Kotputli aiming to enhance their proficiency in financial management and digital accounting practices. Enroll today to gain practical skills in Tally and navigate the complexities of GST seamlessly in Kotputli’s digital-driven environment.</p>
    </div>
    <div className="secound col-sm header-img">
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="./images/digital_computer_technology_kotputli_tally-with-gst-course.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/digital_computer_technology_kotputli_company.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_balance_sheet.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
    ...
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_tallyicon-1.png" width={"80px"} alt=""/>
      <h5 className="mt-5 mb-2 text-uppercase fw-bold">INTRODUCTION</h5>
      <p>Introducing Tally-with-GST in Kotputli, integrating Digital Computer Technology for comprehensive accounting and taxation skills essential in modern business environments.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_tallyicon-2.png" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">COMPANY FORMATION</h5>
      <p>Learn Tally-with-GST in Kotputli for streamlined company formation. Utilize Digital Computer Technology for efficient accounting and compliance in business operations.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_tallyicon-3.png" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">BALANCE SHEET</h5>
      <p>Master Tally-with-GST in Kotputli, learning Digital Computer Technology for accurate balance sheet management and financial reporting in modern business environments.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_tallyicon-4.png" width={"80px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">SERVICES TAX</h5>
      <p>Explore Tally-with-GST in Kotputli, mastering Digital Computer Technology for efficient services tax management and compliance in contemporary business practices.</p>
    </div>
  </div>
            </div>
        </section>
    ...
    <div className="col-sm  popular-courses shadow bg-body-tertiary rounded">
    <Link to="/webdesigner"><img src="./images/digital_computer_technology_kotputli_ethical-hacking.webp" width={"100%"} alt=""/></Link>

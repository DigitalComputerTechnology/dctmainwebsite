...
function WebDesigner() {
    return ( 
        <>
        <section className="courses-first-section pt-4" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/digital_computer_technology_kotputli_web-design_headimg.png)`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
        <Header/>
            <div className="container my-5">
            <div className="row text-center">
            <h1 className="text-uppercase fw-bolder fs-2 text-white">A powerful professional course that is easy to use for WEB-DESIGNER.</h1>
    ...
    <button type="button" className="btn text-white fw-bold px-4 my-3 mx-3 rounded-pill">FEES: 50,000/- Only</button>
      <p className="pe-5">
        ...
        </div>Embark on a dynamic journey with our web designer course in Kotputli, Best Computer Courses in Kotputli merging creativity with advanced digital computer technology. Affordable Computer Classes Kotputli Master essential skills in web development, responsive design, and UI/UX principles tailored for today’s digital era. Ideal for aspiring designers and professionals in Kotputli seeking to elevate their careers in website creation. Advanced Programming Classes Kotputli Enroll now to gain hands-on experience with the latest tools and techniques, and become proficient in crafting innovative and user-friendly</p>
    </div>
    <div className="secound col-sm header-img">
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="./images/digital_computer_technology_kotputli_web-design_slide1.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/digital_computer_technology_kotputli_web-design_slide2.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_web-design_slide3.webp" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
      ...
      <img className="p-0 cdd" src="./images/digital_computer_technology_kotputli_digital1.png" alt=""/>
        ...
        <section className="courses-third-section my-5 pt-5">
            ...
            <div className="row">
              ...
              <p className="text-center fs-5 mt-3 mb-5 main-paragraph">OnLearning is a powerful online software suite that combines all the tools of Kotputli <br/> Digital Computer Technology Courses, Kotputli Computer Science Classes.<br/>
    ...
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      ...
      <p>Introduction to web design in Kotputli with a focus on services tax. Learn Digital Computer Technology tools for creating compliant and visually appealing websites.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      ...
      <p>Learn responsive design in Kotputli with Digital Computer Technology. Master services tax implications for creating adaptable and compliant websites.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_web-design_icon3.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">CLIENT REQUIREMENTS</h5>
      <p>Master client requirements in web design in Kotputli. Utilize Digital Computer Technology for services tax compliance and tailored website development solutions.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_web-design_icon4.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">Layout design</h5>
      <p>Explore layout design in Kotputli with Digital Computer Technology. Learn to integrate services tax considerations for creating visually compelling and compliant web layouts.</p>
    </div>
  </div>
  <div className="row my-4">
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_web-design_icon5.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">FILTER EFFECTS</h5>
      <p>Master filter effects in web design in Kotputli. Utilize Digital Computer Technology with services tax awareness for creative and compliant web visuals.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_web-design_icon6.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">TEXT TOOLS</h5>
      <p>Learn text tools in web design in Kotputli. Utilize Digital Computer Technology while understanding services tax implications for versatile and compliant website typography.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      <img src="./images/digital_computer_technology_kotputli_web-design_icon7.png" width={"100px"} alt=""/>
      <h5 className="mt-4 mb-2 text-uppercase fw-bold">COLOR MODES</h5>
      <p>Master color modes in web design in Kotputli. Utilize Digital Computer Technology, ensuring services tax compliance for vibrant and visually appealing websites.</p>
    </div>
    <div className="col-sm py-3 me-2 shadow bg-body-tertiary rounded">
      ...
      <p>Achieve stunning final results in web design in Kotputli. Incorporate Digital Computer Technology with services tax knowledge for polished, compliant website creations.</p>
    </div>
  </div>
            </div>
        </section>
  ...
  <div className="col-sm  popular-courses shadow bg-body-tertiary rounded">
    <Link to="/ethicalheacking"><img src="./images/digital_computer_technology_kotputli_app-development.webp" width={"100%"} alt=""/></Link>
    ...
    <div className="col-sm mx-3 popular-courses shadow bg-body-tertiary rounded">
    <Link to="/codingforkids"><img src="./images/digital_computer_technology_kotputli_cyber-security.webp" width={"100%"} alt=""/></Link>
